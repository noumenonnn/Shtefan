(function() {
  ...
  // initiate roll
  var roll = Roll.DOM( ".screen-wrapper", ".pane", ".screens", ".step", 100 );
  ...
  window.goto = function(index) {
    var viewport = document.querySelector( ".screen-wrapper" );
  ...
  window.addEventListener("resize", function(evt) {
    roll = Roll.DOM( ".screen-wrapper", ".pane", ".steps", ".step", 100 );
    track();
    goto(0);
  });
